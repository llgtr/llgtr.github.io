(()=>{var h=(()=>{let t=0,r=o=>document.getElementById(o),s=o=>{r("lb-img").src="",t=o,r("lb-img").src=images[t].dataset.full||images[t].src},l=o=>{let v=o.closest(".gallery")||o.closest("figure");images=v?[...v.querySelectorAll("img")]:[o];let d=images.indexOf(o);s(d>=0?d:0),r("lightbox").classList.add("active"),document.body.style.overflow="hidden",document.addEventListener("keydown",c)},e=()=>{r("lightbox").classList.remove("active"),document.body.style.overflow="",document.removeEventListener("keydown",c)},m=()=>{t>0&&s(t-1)},f=()=>{t<images.length-1&&s(t+1)},c=o=>{o.key==="Escape"&&e(),o.key==="ArrowLeft"&&m(),o.key==="ArrowRight"&&f()};return r("lb-close")?.addEventListener("click",e),r("lb-prev")?.addEventListener("click",m),r("lb-next")?.addEventListener("click",f),{open:l}})();window.toggleFrame=t=>h.open(t);var b=()=>{let t=document.getElementById("hero-canvas"),r=document.getElementById("hero-text");if(!t||!r)return;let s=0,l=0;t.addEventListener("mousemove",a=>{let n=t.getBoundingClientRect();s=(a.clientX-n.left)/n.width-.5,l=(a.clientY-n.top)/n.height-.5});let e=t.getContext("webgl");if(!e)return;e.getExtension("OES_standard_derivatives");let m=`
  ...
  `;function c(a,n){let i=e.createShader(a);return e.shaderSource(i,n),e.compileShader(i),i}let o=e.createProgram();if(e.attachShader(o,c(e.VERTEX_SHADER,m)),e.attachShader(o,c(e.FRAGMENT_SHADER,f)),e.linkProgram(o),!e.getProgramParameter(o,e.LINK_STATUS))return;e.useProgram(o),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA);let v=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,v),e.bufferData(e.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),e.STATIC_DRAW);let d=e.getAttribLocation(o,"pos");e.enableVertexAttribArray(d),e.vertexAttribPointer(d,2,e.FLOAT,!1,0,0);let p=e.getUniformLocation(o,"t"),y=e.getUniformLocation(o,"res"),g=e.getUniformLocation(o,"mouse");function u(a){let n=window.devicePixelRatio||1,i=t.clientWidth*n,x=t.clientHeight*n;(t.width!==i||t.height!==x)&&(t.width=i,t.height=x,e.viewport(0,0,i,x)),e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.uniform1f(p,a*.001),e.uniform2f(y,t.width,t.height),e.uniform2f(g,s,l),e.drawArrays(e.TRIANGLE_STRIP,0,4),requestAnimationFrame(u)}t.style.display="block",r&&(r.style.display="none"),requestAnimationFrame(u)};b();})();
